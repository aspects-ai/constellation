...
export type { BackendConfig, DockerBackendConfig, FileSystemBackend, LocalBackendConfig, RemoteBackendConfig } from './backends/types.js';
/**
...
export declare class FileSystemError extends Error {
    ...
    constructor(message: string, code: string, command?: string | undefined);
}
export declare class DangerousOperationError extends FileSystemError {
